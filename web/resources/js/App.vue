    ...
    <div id="slides-shop" class="cover-slides">
        <ul class="slides-container">
            <li class="text-center">
                <img src="images/banner-kennel-01.jpg" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
            ...
            <li class="text-center">
                <img src="images/banner-kennel-02.jpg" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>SILMUGI KENNEL OPC</strong></h1>
            ...
            <li class="text-center">
                <img src="images/banner-kennel-03.jpg" alt="">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>SILMUGI KENNEL OPC</strong></h1>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img class="img-fluid" src="images/featured-puppies-1.jpg" alt="" />
    ...
    <div class="categories-shop">
      <div class="container">
          ...
          <div class="row">
              <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                  <div class="shop-cat-box">
                      <img class="img-fluid" src="images/puppies.jpg" alt="" />
                      <a class="btn hvr-hover" href="#">Lorem ipsum dolor</a>
                  </div>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
